        ...
        return Stack(
            children: <Widget>[
                Visibility(
                    ...
                    child: Container(
                        padding: widget.inputDecoration!=null? widget.inputDecoration.contentPadding:
                        EdgeInsets.symmetric(vertical: 10 + (widget.fontSize.toDouble()/14),horizontal: 0 )
                        ,
                        child: Text(
                            _matches.isNotEmpty ?  (
                                _matches.first
